...
<div class="text-center">
         <image class="rounded-circle" src="http://www.asia.edu.tw/Main_pages/yard/New_Buildings/Administration%20Building.jpg" alt="my_image2" height="300" width="400" />
    </div>
...
<div style="text-align:center;">
      ...
      <form class="form-signin" method="POST" action="login.php">
        ...
        <input type="text" name="SID" id="SID" class="form-control" placeholder="Email address" required autofocus>
        <?php echo $msgError; ?>
